...
diva_db <- read_csv("/Users/catherineledna/.julia/dev/MimiCIAM/data/input/data.csv")%>%group_by(X1)%>%
  mutate(area=sum(area1,area2,area3,area4,area5,area6,area7,area8,area9,area10,area11,area12,area13,area14,area15))
diva_latlon <- read_csv("/Users/catherineledna/.julia/dev/MimiCIAM/data/diva_segment_latlon.csv")

diva_lines <- read_sf("/Users/catherineledna/Desktop/CIAM-GIS/COASTLINES/diva_published-master-data-gis/data/gis/cls.shp")
...
# Read Area Data
area_data <- raster("Desktop/CIAM-GIS/GPW-LANDAREA-30/gpw-v4-land-water-area-rev11_landareakm_30_sec_tif/gpw_v4_land_water_area_rev11_landareakm_30_sec.tif")

# Read Merkens Data 
SSP<-2

ssp_2060m <- raster(paste0("/Users/catherineledna/Desktop/CIAM-GIS/POPDATA/MERKENS_2016/DIVA_SSP",SSP,"_2060.tif"))
ssp_2070m <- raster(paste0("/Users/catherineledna/Desktop/CIAM-GIS/POPDATA/MERKENS_2016/DIVA_SSP",SSP,"_2070.tif"))
ssp_2080m <- raster(paste0("/Users/catherineledna/Desktop/CIAM-GIS/POPDATA/MERKENS_2016/DIVA_SSP",SSP,"_2080.tif"))
ssp_2090m <- raster(paste0("/Users/catherineledna/Desktop/CIAM-GIS/POPDATA/MERKENS_2016/DIVA_SSP",SSP,"_2090.tif"))
ssp_2100m <- raster(paste0("/Users/catherineledna/Desktop/CIAM-GIS/POPDATA/MERKENS_2016/DIVA_SSP",SSP,"_2100.tif"))

ssp_2010m <- raster(paste0("/Users/catherineledna/Desktop/CIAM-GIS/POPDATA/MERKENS_2016/DIVA_SSP",SSP,"_2010.tif"))
ssp_2020m <- raster(paste0("/Users/catherineledna/Desktop/CIAM-GIS/POPDATA/MERKENS_2016/DIVA_SSP",SSP,"_2020.tif"))
ssp_2030m <- raster(paste0("/Users/catherineledna/Desktop/CIAM-GIS/POPDATA/MERKENS_2016/DIVA_SSP",SSP,"_2030.tif"))
ssp_2040m <- raster(paste0("/Users/catherineledna/Desktop/CIAM-GIS/POPDATA/MERKENS_2016/DIVA_SSP",SSP,"_2040.tif"))
ssp_2050m <- raster(paste0("/Users/catherineledna/Desktop/CIAM-GIS/POPDATA/MERKENS_2016/DIVA_SSP",SSP,"_2050.tif"))


# Jones Data: Read coastal population data as raster. Unit: # of persons  
ncname <- paste0("/Users/catherineledna/Desktop/CIAM-GIS/POPDATA/popdynamics-1-km-downscaled-pop-base-year-projection-ssp-2000-2100-rev01-proj-ssp",SSP,"-netcdf/SSP",SSP,"_1km/ssp",SSP,"_total_2060.nc4")
ssp_2060j <-raster(ncname,varname="Band1")
ssp_2070j <- raster(paste0("/Users/catherineledna/Desktop/CIAM-GIS/POPDATA/popdynamics-1-km-downscaled-pop-base-year-projection-ssp-2000-2100-rev01-proj-ssp",SSP,"-netcdf/SSP",SSP,"_1km/ssp",SSP,"_total_2070.nc4"),varname="Band1")
ssp_2080j <- raster(paste0("/Users/catherineledna/Desktop/CIAM-GIS/POPDATA/popdynamics-1-km-downscaled-pop-base-year-projection-ssp-2000-2100-rev01-proj-ssp",SSP,"-netcdf/SSP",SSP,"_1km/ssp",SSP,"_total_2080.nc4"),varname="Band1")
ssp_2090j <- raster(paste0("/Users/catherineledna/Desktop/CIAM-GIS/POPDATA/popdynamics-1-km-downscaled-pop-base-year-projection-ssp-2000-2100-rev01-proj-ssp",SSP,"-netcdf/SSP",SSP,"_1km/ssp",SSP,"_total_2090.nc4"),varname="Band1")
ssp_2100j <- raster(paste0("/Users/catherineledna/Desktop/CIAM-GIS/POPDATA/popdynamics-1-km-downscaled-pop-base-year-projection-ssp-2000-2100-rev01-proj-ssp",SSP,"-netcdf/SSP",SSP,"_1km/ssp",SSP,"_total_2100.nc4"),varname="Band1")

ssp_2010j <-raster(paste0("/Users/catherineledna/Desktop/CIAM-GIS/POPDATA/popdynamics-1-km-downscaled-pop-base-year-projection-ssp-2000-2100-rev01-proj-ssp",SSP,"-netcdf/SSP",SSP,"_1km/ssp",SSP,"_total_2010.nc4"),varname="Band1")
ssp_2020j <- raster(paste0("/Users/catherineledna/Desktop/CIAM-GIS/POPDATA/popdynamics-1-km-downscaled-pop-base-year-projection-ssp-2000-2100-rev01-proj-ssp",SSP,"-netcdf/SSP",SSP,"_1km/ssp",SSP,"_total_2020.nc4"),varname="Band1")
ssp_2030j <- raster(paste0("/Users/catherineledna/Desktop/CIAM-GIS/POPDATA/popdynamics-1-km-downscaled-pop-base-year-projection-ssp-2000-2100-rev01-proj-ssp",SSP,"-netcdf/SSP",SSP,"_1km/ssp",SSP,"_total_2030.nc4"),varname="Band1")
ssp_2040j <- raster(paste0("/Users/catherineledna/Desktop/CIAM-GIS/POPDATA/popdynamics-1-km-downscaled-pop-base-year-projection-ssp-2000-2100-rev01-proj-ssp",SSP,"-netcdf/SSP",SSP,"_1km/ssp",SSP,"_total_2040.nc4"),varname="Band1")
ssp_2050j <- raster(paste0("/Users/catherineledna/Desktop/CIAM-GIS/POPDATA/popdynamics-1-km-downscaled-pop-base-year-projection-ssp-2000-2100-rev01-proj-ssp",SSP,"-netcdf/SSP",SSP,"_1km/ssp",SSP,"_total_2050.nc4"),varname="Band1")


# Read coastal buffer data 
buffer <- read_sf("/Users/catherineledna/Desktop/CIAM-GIS/buffer/buffer2.shp")
...
outname <- "Desktop/CIAM-GIS/output_ssp2_2060_2100.csv"
...
dupes <- c()
for (i in segs_out){
  tmp <- outdf %>% filter(year==2010,ciamID==i)
  if (nrow(tmp)>1){
    dupes <- c(dupes,i)
  }
...
outdf_new <- outdf %>% filter(!(ciamID %in% dupes))
outdf_new <- rbind(outdf_new,outdf2)

psegs <- ciam_Names[!(ciam_Names%in%unique(outdf_new$ciamID))]
prob_segs <- c(psegs)
...
buffer_prob <- read_sf("Desktop/CIAM-GIS/divaProbs/buffer_probs3.shp")
